...
from .views import HomeView, trips_list, TripCreateView, TripDetailView, TripUpdateView, TripDeleteView, NoteDetailView,NoteListView, NoteCreateView, NoteUpdateView, NoteDeleteView
